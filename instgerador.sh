...
fun_montaip () {
fun_ip
sed -i "s;18.229.138.175;$IP;g" /var/www/html/scripts/Plus
fun_ip
sed -i "s;18.229.138.175;$IP;g" /home/list
fun_ip
sed -i "s;18.229.138.175;$IP;g" /home/index.html
sleep 3s
}
...
clear
echo -e "$barra"
echo -e "       \033[1;33mINSTALADOR KEY SSH PRO MAX !\033[0m"
echo -e "$barra"
echo ""
